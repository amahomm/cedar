...
/// Wrapper for annotated elements (same pattern as schema)
...
/// A value in entity data (restricted expression — no operators, variables, methods)
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum EntityValue {
    ...
    /// Extension function call: `datetime("2024-01-01")`
    ExtensionCall {
...
#[expect(clippy::type_complexity, reason = "matches schema pattern")]
